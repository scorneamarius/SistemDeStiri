...
public class Main {
    ...
    public static void main(String[] args) throws URISyntaxException, JMSException {
        ...
        Producer p1 = new Producer("Producer1",new News(topicName1,"Text from Producer1",News.EventType.ADD), observableMap,newsList);
        Producer p2 = new Producer("Producer2",new News(topicName2,"Text from Producer2",News.EventType.ADD), observableMap,newsList);
